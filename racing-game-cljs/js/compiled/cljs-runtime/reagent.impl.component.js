...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38596 = c;
var G__38596__$1 = (((G__38596 == null))?null:G__38596.prototype);
if((G__38596__$1 == null)){
return null;
} else {
return G__38596__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38597 = c;
var G__38597__$1 = (((G__38597 == null))?null:G__38597.prototype);
if((G__38597__$1 == null)){
return null;
} else {
return G__38597__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__38788__delegate = function (args){
...
while (G__38789__i < G__38789__a.length) {G__38789__a[G__38789__i] = arguments[G__38789__i + 0]; ++G__38789__i;}
  args = new cljs.core.IndexedSeq(G__38789__a,0,null);
} 
return G__38788__delegate.call(this,args);};
G__38788.cljs$lang$maxFixedArity = 0;
G__38788.cljs$lang$applyTo = (function (arglist__38790){
var args = cljs.core.seq(arglist__38790);
return G__38788__delegate(args);
});
...
var or__4223__auto__ = (function (){var G__38637 = c;
var G__38637__$1 = (((G__38637 == null))?null:G__38637.constructor);
if((G__38637__$1 == null)){
return null;
} else {
return G__38637__$1.displayName;
}
})();
...
var _STAR_current_component_STAR__orig_val__38662 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38663 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38663);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38662);
}});
...
var c = this;
var G__38704_38802 = goog.object.get(c,"cljsRatom");
if((G__38704_38802 == null)){
} else {
reagent.ratom.dispose_BANG_(G__38704_38802);
}
...
var renders_38809 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_38810 = cljs.core.first(cljs.core.vals(renders_38809));
...
if((cljs.core.count(renders_38809) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_38809))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_38810)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_38810], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__38717 = o;
goog.object.set(G__38717,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__38740 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38741 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38741);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38740);
}});
...
var vec__38747 = shadow.js.shim.module$react.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38747,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38747,(1),null);
...
var G__38760 = goog.object.get(reagent_state,"cljsRatom");
if((G__38760 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__38760);
}
});
}),[]);
