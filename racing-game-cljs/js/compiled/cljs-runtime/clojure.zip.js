...
var G__37242 = clojure.zip.node(loc);
var fexpr__37241 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__37241.cljs$core$IFn$_invoke$arity$1 ? fexpr__37241.cljs$core$IFn$_invoke$arity$1(G__37242) : fexpr__37241.call(null,G__37242));
});
/**
...
var G__37270 = clojure.zip.node(loc);
var fexpr__37269 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__37269.cljs$core$IFn$_invoke$arity$1 ? fexpr__37269.cljs$core$IFn$_invoke$arity$1(G__37270) : fexpr__37269.call(null,G__37270));
} else {
...
var fexpr__37278 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__37278.cljs$core$IFn$_invoke$arity$2 ? fexpr__37278.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__37278.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__37315 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37315,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37315,(1),null);
var vec__37318 = clojure.zip.children(loc);
var seq__37319 = cljs.core.seq(vec__37318);
var first__37320 = cljs.core.first(seq__37319);
var seq__37319__$1 = cljs.core.next(seq__37319);
var c = first__37320;
var cnext = seq__37319__$1;
var cs = vec__37318;
...
var vec__37336 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37336,(0),null);
var map__37339 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37336,(1),null);
var map__37339__$1 = cljs.core.__destructure_map(map__37339);
var path = map__37339__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37339__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37339__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37339__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37339__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37339__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__37377 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37377,(0),null);
var map__37380 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37377,(1),null);
var map__37380__$1 = cljs.core.__destructure_map(map__37380);
var path = map__37380__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37380__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__37381 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37380__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__37382 = cljs.core.seq(vec__37381);
var first__37383 = cljs.core.first(seq__37382);
var seq__37382__$1 = cljs.core.next(seq__37382);
var r = first__37383;
var rnext = seq__37382__$1;
var rs = vec__37381;
...
var vec__37413 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37413,(0),null);
var map__37416 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37413,(1),null);
var map__37416__$1 = cljs.core.__destructure_map(map__37416);
var path = map__37416__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37416__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37416__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
return r;
} else {
...
var vec__37418 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37418,(0),null);
var map__37421 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37418,(1),null);
var map__37421__$1 = cljs.core.__destructure_map(map__37421);
var path = map__37421__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37421__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37421__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
...
var vec__37426 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37426,(0),null);
var map__37429 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37426,(1),null);
var map__37429__$1 = cljs.core.__destructure_map(map__37429);
var path = map__37429__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37429__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37429__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__37438 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37438,(0),null);
var map__37441 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37438,(1),null);
var map__37441__$1 = cljs.core.__destructure_map(map__37441);
var path = map__37441__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37441__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__37442 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37442,(0),null);
...
var path = map__37445__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37445__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__37449 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37449,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37449,(1),null);
...
var len__4829__auto___37485 = arguments.length;
var i__4830__auto___37486 = (0);
while(true){
if((i__4830__auto___37486 < len__4829__auto___37485)){
args__4835__auto__.push((arguments[i__4830__auto___37486]));

var G__37487 = (i__4830__auto___37486 + (1));
i__4830__auto___37486 = G__37487;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq37455){
var G__37456 = cljs.core.first(seq37455);
var seq37455__$1 = cljs.core.next(seq37455);
var G__37457 = cljs.core.first(seq37455__$1);
var seq37455__$2 = cljs.core.next(seq37455__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37456,G__37457,seq37455__$2);
}));
...
var G__37494 = clojure.zip.rightmost(child);
loc__$1 = G__37494;
continue;
} else {
return loc__$1;
...
var vec__37466 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37466,(0),null);
var map__37469 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37466,(1),null);
var map__37469__$1 = cljs.core.__destructure_map(map__37469);
var path = map__37469__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37469__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37469__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37469__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37469__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__37495 = clojure.zip.rightmost(child);
loc__$1 = G__37495;
continue;
} else {
return loc__$1;
