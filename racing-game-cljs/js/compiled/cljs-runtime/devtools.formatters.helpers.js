...
var G__28114 = devtools.prefs.pref(v);
v = G__28114;
continue;
} else {
return v;
...
}catch (e28028){var _e__27450__auto__ = e28028;
return false;
}})();
...
}catch (e28035){var _e__27450__auto__ = e28035;
return false;
}})();
...
}catch (e28038){var _e__27450__auto__ = e28038;
return false;
}}
}
});
...
var vec__28065 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28065,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28065,(1),null);
...
return cljs.core.some((function (p1__28072_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28072_SHARP_);
}),template);
});
