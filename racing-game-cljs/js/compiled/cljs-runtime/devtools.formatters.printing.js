...
var G__28249 = (i__4830__auto___28247 + (1));
i__4830__auto___28247 = G__28249;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28137){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28138,G__28139,seq28137__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28164_SHARP_){
return (!((cljs.core.meta(p1__28164_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28184__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28188){var _e__27450__auto__ = e28188;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e28195){var _e__27450__auto__ = e28195;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28204 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28205 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28205);

try{var map__28206 = opts;
var map__28206__$1 = cljs.core.__destructure_map(map__28206);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28206__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28204);
}});
...
var temp__5751__auto___28258 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___28258)){
var managed_print_level_28259 = temp__5751__auto___28258;
var _STAR_print_level_STAR__orig_val__28212_28260 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28213_28261 = managed_print_level_28259;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28213_28261);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28207_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28207_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28212_28260);
}} else {
job_fn();
}
