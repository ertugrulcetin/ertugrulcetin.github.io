...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__40418){
var vec__40420 = p__40418;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40420,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40420,(1),null);
...
return clojure.zip.zipper((function (p1__40423_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__40423_SHARP_)) || (cljs.core.map_QMARK_(p1__40423_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__40428){
var vec__40431 = p__40428;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40431,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40431,(1),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__40450_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__40450_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40449_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__40449_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__40451_SHARP_){
return (((p1__40451_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__40451_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__40486,mapping){
var map__40487 = p__40486;
var map__40487__$1 = cljs.core.__destructure_map(map__40487);
var state = map__40487__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40487__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40487__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40487__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__40482_SHARP_){
var and__4221__auto__ = (p1__40482_SHARP_ instanceof cljs.core.Symbol);
if(and__4221__auto__){
return cljs.core.namespace(p1__40482_SHARP_);
} else {
...
var G__40718 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__40719 = clojure.zip.next(loc);
loc = G__40719;
continue;
}
}
...
var len__4829__auto___40726 = arguments.length;
var i__4830__auto___40727 = (0);
while(true){
if((i__4830__auto___40727 < len__4829__auto___40726)){
args__4835__auto__.push((arguments[i__4830__auto___40727]));

var G__40728 = (i__4830__auto___40727 + (1));
i__4830__auto___40727 = G__40728;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__40551){
var vec__40552 = p__40551;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40552,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq40543){
var G__40544 = cljs.core.first(seq40543);
var seq40543__$1 = cljs.core.next(seq40543);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40544,seq40543__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__40556_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__40556_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__40564_40729 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__40565_40730 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__40566_40731 = true;
var _STAR_print_fn_STAR__temp_val__40567_40732 = (function (x__4761__auto__){
return sb__4760__auto__.append(x__4761__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__40566_40731);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__40567_40732);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__40565_40730);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__40564_40729);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4760__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__40563_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__40563_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__40735 = cljs.core.next(opts__$1);
var G__40736 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__40735;
acc = G__40736;
continue;
} else {
if(typeof f === 'string'){
var G__40737 = cljs.core.next(opts__$1);
var G__40738 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__40737;
acc = G__40738;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__40739 = cljs.core.nnext(opts__$1);
var G__40740 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__40739;
acc = G__40740;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__40741 = cljs.core.next(opts__$1);
var G__40742 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__40741;
acc = G__40742;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__40595 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__40595.cljs$core$IFn$_invoke$arity$1 ? fexpr__40595.cljs$core$IFn$_invoke$arity$1(f) : fexpr__40595.call(null,f));
})())){
var G__40743 = cljs.core.next(opts__$1);
var G__40744 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__40743;
acc = G__40744;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__40600 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__40600.cljs$core$IFn$_invoke$arity$1 ? fexpr__40600.cljs$core$IFn$_invoke$arity$1(f) : fexpr__40600.call(null,f));
})())){
var G__40745 = cljs.core.nnext(opts__$1);
var G__40746 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__40745;
acc = G__40746;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__40747 = cljs.core.next(opts__$1);
var G__40748 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__40747;
acc = G__40748;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__40616){
var vec__40621 = p__40616;
...
var G__40640 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__40639 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__40665 = quoted_form;
var G__40666 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__40665,G__40666) : day8.re_frame.debux.common.util.remove_d.call(null,G__40665,G__40666));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__40687 = quoted_form;
var G__40688 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__40687,G__40688) : day8.re_frame.debux.common.util.remove_d.call(null,G__40687,G__40688));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__40757__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__40698 = quoted_form;
var G__40699 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__40698,G__40699) : day8.re_frame.debux.common.util.remove_d.call(null,G__40698,G__40699));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__40761__i < G__40761__a.length) {G__40761__a[G__40761__i] = arguments[G__40761__i + 0]; ++G__40761__i;}
  arg = new cljs.core.IndexedSeq(G__40761__a,0,null);
} 
return G__40757__delegate.call(this,arg);};
G__40757.cljs$lang$maxFixedArity = 0;
G__40757.cljs$lang$applyTo = (function (arglist__40762){
var arg = cljs.core.seq(arglist__40762);
return G__40757__delegate(arg);
});
...
var G__40763 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__40763;
continue;
} else {
...
var G__40764 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__40764;
continue;
} else {
var G__40765 = clojure.zip.next(loc);
loc = G__40765;
continue;
