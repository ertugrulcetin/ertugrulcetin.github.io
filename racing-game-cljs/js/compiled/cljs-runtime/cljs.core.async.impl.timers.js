...
var i_32673 = (0);
while(true){
if((i_32673 < arr.length)){
(arr[i_32673] = null);

var G__32674 = (i_32673 + (1));
i_32673 = G__32674;
continue;
} else {
}
...
var i_32685 = (self__.level + (1));
while(true){
if((i_32685 <= (new_level + (1)))){
(update[i_32685] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32687 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32687[i]));
} else {
x__$2.forward.push((((i < links_32687.length))?(links_32687[i]):null));
}

if((i < links_32687.length)){
(links_32687[i] = x__$2);
} else {
links_32687.push(x__$2);
}
...
var i_32689 = (0);
while(true){
if((i_32689 <= self__.level)){
var links_32690 = (update[i_32689]).forward;
if((x__$1 === (((i_32689 < links_32690.length))?(links_32690[i_32689]):null))){
(links_32690[i_32689] = (x__$1.forward[i_32689]));

var G__32691 = (i_32689 + (1));
i_32689 = G__32691;
continue;
} else {
var G__32692 = (i_32689 + (1));
i_32689 = G__32692;
continue;
}
} else {
...
var G__32694 = nx;
var G__32695 = (level__$1 - (1));
x = G__32694;
level__$1 = G__32695;
continue;
} else {
var G__32696 = x;
var G__32697 = (level__$1 - (1));
x = G__32696;
level__$1 = G__32697;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__32699 = nx;
var G__32700 = (level__$1 - (1));
x = G__32699;
level__$1 = G__32700;
continue;
} else {
var G__32701 = x;
var G__32702 = (level__$1 - (1));
x = G__32701;
level__$1 = G__32702;
continue;
}
