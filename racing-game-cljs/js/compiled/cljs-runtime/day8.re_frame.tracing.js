...
var G__41640 = clojure.zip.next(loc);
var G__41641 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(seen,node);
loc = G__41640;
seen = G__41641;
continue;
} else {
var G__41642 = clojure.zip.next(loc);
var G__41643 = seen;
loc = G__41642;
seen = G__41643;
continue;
...
var len__4829__auto___41645 = arguments.length;
var i__4830__auto___41646 = (0);
while(true){
if((i__4830__auto___41646 < len__4829__auto___41645)){
args__4835__auto__.push((arguments[i__4830__auto___41646]));

var G__41647 = (i__4830__auto___41646 + (1));
i__4830__auto___41646 = G__41647;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame.tracing.fn_body.cljs$lang$applyTo = (function (seq41595){
var G__41596 = cljs.core.first(seq41595);
var seq41595__$1 = cljs.core.next(seq41595);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41596,seq41595__$1);
}));
