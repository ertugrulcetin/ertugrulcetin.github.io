...
var G__38849 = o;
goog.object.set(G__38849,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__38958__i < G__38958__a.length) {G__38958__a[G__38958__i] = arguments[G__38958__i + 0]; ++G__38958__i;}
  args = new cljs.core.IndexedSeq(G__38958__a,0,null);
} 
...
var args = cljs.core.seq(arglist__38959);
...
var G__38852 = o;
goog.object.set(G__38852,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__38960__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__38960 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38961__i = 0, G__38961__a = new Array(arguments.length -  0);
while (G__38961__i < G__38961__a.length) {G__38961__a[G__38961__i] = arguments[G__38961__i + 0]; ++G__38961__i;}
  args = new cljs.core.IndexedSeq(G__38961__a,0,null);
} 
return G__38960__delegate.call(this,args);};
G__38960.cljs$lang$maxFixedArity = 0;
G__38960.cljs$lang$applyTo = (function (arglist__38962){
var args = cljs.core.seq(arglist__38962);
return G__38960__delegate(args);
});
...
var G__38858 = props;
var G__38858__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38858,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38858);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38858__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__38860 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38860,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__38860;
}
})(),id_class);
...
var G__38865 = (cljs.core.count(argv) - first_child);
switch (G__38865) {
case (0):
...
var vec__38868 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38868,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38868,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38868,(2),null);
...
var temp__5757__auto___38970 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___38970 == null)){
} else {
var key_38971 = temp__5757__auto___38970;
(jsprops.key = key_38971);
}
...
var temp__5757__auto___38972 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___38972 == null)){
} else {
var key_38973 = temp__5757__auto___38972;
(jsprops.key = key_38973);
}
...
var temp__5757__auto___38975 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___38975 == null)){
} else {
var key_38977 = temp__5757__auto___38975;
(jsprops.key = key_38977);
}
...
var temp__5757__auto___38983 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___38983 == null)){
} else {
var key_38984 = temp__5757__auto___38983;
(jsprops.key = key_38984);
}
...
var temp__5757__auto___38986 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___38986 == null)){
} else {
var key_38987 = temp__5757__auto___38986;
(jsprops.key = key_38987);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38895_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__38895_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__38899 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38899,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38899,(1),null);
...
break;
default:
var G__38995 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__38996 = compiler;
v = G__38995;
compiler = G__38996;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template38927 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template38927 = (function (opts,id,fn_to_element,parse_fn,meta38928){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template38927.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38929,meta38928__$1){
var self__ = this;
var _38929__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template38927(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta38928__$1));
}));

(reagent.impl.template.t_reagent$impl$template38927.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38929){
var self__ = this;
var _38929__$1 = this;
return self__.meta38928;
}));

(reagent.impl.template.t_reagent$impl$template38927.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template38927.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template38927.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template38927.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template38927.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template38927.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta38928","meta38928",-1617343063,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template38927.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template38927.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template38927");

(reagent.impl.template.t_reagent$impl$template38927.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template38927");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template38927.
 */
reagent.impl.template.__GT_t_reagent$impl$template38927 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template38927(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta38928){
return (new reagent.impl.template.t_reagent$impl$template38927(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta38928));
});

}

return (new reagent.impl.template.t_reagent$impl$template38927(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
