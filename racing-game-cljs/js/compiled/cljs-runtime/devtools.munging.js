...
var o27754 = temp__5751__auto__;
var temp__5751__auto____$1 = (o27754["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o27755 = temp__5751__auto____$1;
return (o27755["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27420__auto__ = f;
return (o__27420__auto__["toString"]).call(o__27420__auto__);
} else {
return "";
}
}catch (e27757){var _ = e27757;
return "";
}});
...
try{var o__27420__auto___28017 = t;
(o__27420__auto___28017["cljs$lang$ctorPrWriter"]).call(o__27420__auto___28017,t,writer);
}catch (e27764){var __28019 = e27764;
}
...
var char_code = (function (){var o__27420__auto__ = (new String(char$));
return (o__27420__auto__["charCodeAt"]).call(o__27420__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27420__auto__ = String;
return (o__27420__auto__["fromCharCode"]).call(o__27420__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27777 = num_code;
switch (G__27777) {
case (1):
return (185);
...
var o__27420__auto__ = String;
return (o__27420__auto__["fromCharCode"]).call(o__27420__auto__,superscript_code);
});
/**
...
}catch (e27788){var _e__27450__auto__ = e27788;
return false;
}})())){
...
var vec__27791 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27791,(0),null);
...
var len__4829__auto___28043 = arguments.length;
var i__4830__auto___28044 = (0);
while(true){
if((i__4830__auto___28044 < len__4829__auto___28043)){
args__4835__auto__.push((arguments[i__4830__auto___28044]));

var G__28045 = (i__4830__auto___28044 + (1));
i__4830__auto___28044 = G__28045;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27819){
var vec__27820 = p__27819;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27820,(0),null);
...
var G__28050 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28051 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28050;
remaining_tokens = G__28051;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27816){
var G__27817 = cljs.core.first(seq27816);
var seq27816__$1 = cljs.core.next(seq27816);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27817,seq27816__$1);
}));
...
var vec__27827 = cljs.core.split_with((function (p1__27826_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27826_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27827,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27827,(1),null);
...
var vec__27837 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27837,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27837,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28054 = cljs.core.rest(remaining_tokens);
var G__28055 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28054;
name_tokens = G__28055;
continue;
} else {
...
var vec__27846 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27846,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27846,(1),null);
var vec__27849 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27849,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27849,(1),null);
var vec__27852 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27852,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27852,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27852,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27852,(3),null);
...
var vec__27858 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27858,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27858,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27858,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27858,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27858,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27858,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__27874 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27874,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27874,(1),null);
var vec__27877 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27877,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27877,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27888 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27888) : devtools.munging.parse_fn_info_deep.call(null,G__27888));
})()));
}
} else {
return fn_info;
...
var G__28084 = (arity + (1));
var G__28085 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27902){
var vec__27903 = p__27902;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27903,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27903,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27922_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27922_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27923_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27923_SHARP_);
}),sorted_infos);
...
var args__4835__auto__ = [];
var len__4829__auto___28103 = arguments.length;
var i__4830__auto___28105 = (0);
while(true){
if((i__4830__auto___28105 < len__4829__auto___28103)){
args__4835__auto__.push((arguments[i__4830__auto___28105]));

var G__28107 = (i__4830__auto___28105 + (1));
i__4830__auto___28105 = G__28107;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27932){
var vec__27934 = p__27932;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27934,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27930){
var G__27931 = cljs.core.first(seq27930);
var seq27930__$1 = cljs.core.next(seq27930);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27931,seq27930__$1);
}));
...
var map__27946 = options;
var map__27946__$1 = cljs.core.__destructure_map(map__27946);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27946__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27946__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27946__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27946__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27947 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27947,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27947,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27947,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27947,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27947,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27947,(5),null);
...
var o__27420__auto__ = f;
return (o__27420__auto__["getBasis"]).call(o__27420__auto__);
});
/**
...
}catch (e27951){var _e__27450__auto__ = e27951;
...
var G__28125 = (obj[cljs.core.first(path)]);
var G__28126 = cljs.core.rest(path);
obj = G__28125;
path = G__28126;
continue;
} else {
...
var _STAR_ = (function (accum,p__27979){
var vec__27980 = p__27979;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27980,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27980,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27987){
var vec__27988 = p__27987;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27988,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27988,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27988,(2),null);
...
var post_process = (function (p__28004){
var vec__28005 = p__28004;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28005,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28005,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27998_SHARP_){
return (obj[cljs.core.first(p1__27998_SHARP_)]);
}),sorted_matches);
